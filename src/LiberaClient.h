...
using LiberaSinglePassE_ns::LiberaSinglePassE;
...
class LiberaClient {
public:
    LiberaClient(LiberaSinglePassE *a_deviceServer);
    ~LiberaClient();
    ...
    /**
     * Assign the LiberaSinglePassE object's function to be called
     * if attribute value changes.
     */
    template<typename TangoType>
    void SetNotifier(TangoType *&a_attr, void (LiberaSinglePassE::*a_notifier)())
    {
...
private:
    ...
    LiberaSinglePassE  *m_deviceServer; // used for changing device state
